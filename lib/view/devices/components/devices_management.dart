...
class _DeviceManagementPageState extends State<DeviceManagementPage> {
  ...
  AlertDialog _buildAddDeviceDialog(
    ...
    List<int> selectedImage,
    bool isFormValid,
    void Function(MachineType?) onTypeChanged,
    void Function(List<int>) onImageSelected,
  ) {
    final l10n = AppLocalizations.of(context)!;
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: AppLocalizations.of(context)!.devices_name,
              hintText: AppLocalizations.of(context)!.devices_add_tips,
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: AppLocalizations.of(context)!.devices_identity,
              hintText: AppLocalizations.of(context)!.devices_identity_tips,
              floatingLabelBehavior: FloatingLabelBehavior.always,
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
              ),
          ...
          TextField(
            ...
            obscureText: true,
            decoration: InputDecoration(
              labelText: AppLocalizations.of(context)!.devices_secret,
              hintText: AppLocalizations.of(context)!.devices_secret_tips,
              floatingLabelBehavior: FloatingLabelBehavior.always,
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
              ),
          ...
          const SizedBox(height: 20),
          // 图片选择区域
          _buildImagePicker(context, selectedImage, onImageSelected),
        ],
      ),
    );
  }
    ...
    return Row(
      ...
      children: [
        TextButton(
          ...
          child: Text(
            AppLocalizations.of(context)!.app_cancel,
            style: TextStyle(color: Colors.grey),
          ),
        ),
        ...
        ElevatedButton(
          onPressed: isFormValid
              ...
              : null,
          child: Text(
            AppLocalizations.of(context)!.devices_add,
